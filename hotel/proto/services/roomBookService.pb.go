...
type RoomBookWhere struct {
	...
	RoomTypeId       int64   `protobuf:"varint,9,opt,name=room_type_id,json=roomTypeId,proto3" json:"room_type_id"`
	RoomId           int64   `protobuf:"varint,10,opt,name=room_id,json=roomId,proto3" json:"room_id"`
	Type             string  `protobuf:"bytes,11,opt,name=type,proto3" json:"type"`
	RoomBookDetailId int64   `protobuf:"varint,12,opt,name=room_book_detail_id,json=roomBookDetailId,proto3" json:"room_book_detail_id"`
	// @inject_tag: gorm:"-"
	RoomBookDetailIds []int64 `protobuf:"varint,13,rep,packed,name=room_book_detail_ids,json=roomBookDetailIds,proto3" json:"room_book_detail_ids" gorm:"-"`
}
...
type RoomBook struct {
	...
	RoomBookSn string `protobuf:"bytes,2,opt,name=room_book_sn,json=roomBookSn,proto3" json:"room_book_sn"`
	// @inject_tag: validate:"required" label:"客源信息"
	CustomerType   int32 `protobuf:"varint,3,opt,name=customer_type,json=customerType,proto3" json:"customer_type" validate:"required" label:"客源信息"`
	PlatformSource int32 `protobuf:"varint,4,opt,name=platform_source,json=platformSource,proto3" json:"platform_source"`
	...
	BookName string `protobuf:"bytes,6,opt,name=book_name,json=bookName,proto3" json:"book_name" validate:"required" label:"预订姓名"`
	// @inject_tag: validate:"required" label:"预订手机号"
	BookMobile      string `protobuf:"bytes,7,opt,name=book_mobile,json=bookMobile,proto3" json:"book_mobile" validate:"required" label:"预订手机号"`
	ExternalOrderSn string `protobuf:"bytes,8,opt,name=external_order_sn,json=externalOrderSn,proto3" json:"external_order_sn"`
	// @inject_tag: validate:"required" label:"入住时间"
	CheckinTime string `protobuf:"bytes,9,opt,name=checkin_time,json=checkinTime,proto3" json:"checkin_time" validate:"required" label:"入住时间"`
	// @inject_tag: validate:"required" label:"离店时间"
	CheckoutTime string  `protobuf:"bytes,10,opt,name=checkout_time,json=checkoutTime,proto3" json:"checkout_time" validate:"required" label:"离店时间"`
	DayNum       int32   `protobuf:"varint,11,opt,name=day_num,json=dayNum,proto3" json:"day_num"`
	TotalPrice   float32 `protobuf:"fixed32,12,opt,name=total_price,json=totalPrice,proto3" json:"total_price"`
	...
	Details []*RoomBookDetail `protobuf:"bytes,18,rep,name=details,proto3" json:"details" gorm:"foreignKey:RoomBookId"`
	// @inject_tag: gorm:"-"
	DetailReq     []*AllRoomTypeAndAvailableRoom `protobuf:"bytes,19,rep,name=detail_req,json=detailReq,proto3" json:"detail_req" gorm:"-"`
	OrderId       int64                          `protobuf:"varint,21,opt,name=order_id,json=orderId,proto3" json:"order_id"`
	ExtraBedPrice float32                        `protobuf:"fixed32,22,opt,name=extra_bed_price,json=extraBedPrice,proto3" json:"extra_bed_price"`
	Deposit       float32                        `protobuf:"fixed32,23,opt,name=deposit,proto3" json:"deposit"`
	IsPayDeposit  bool                           `protobuf:"varint,24,opt,name=is_pay_deposit,json=isPayDeposit,proto3" json:"is_pay_deposit"`
	BookRoomJson  string                         `protobuf:"bytes,25,opt,name=book_room_json,json=bookRoomJson,proto3" json:"book_room_json"`
	GiftContent   string                         `protobuf:"bytes,26,opt,name=gift_content,json=giftContent,proto3" json:"gift_content"`
}
...
func (x *RoomBook) GetOrderId() int64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
func (x *RoomBook) GetExtraBedPrice() float32 {
	if x != nil {
...
func (x *RoomBook) GetDeposit() float32 {
	if x != nil {
		return x.Deposit
	}
	return 0
...
func (x *RoomBook) GetIsPayDeposit() bool {
	if x != nil {
		return x.IsPayDeposit
	}
	return false
}

func (x *RoomBook) GetBookRoomJson() string {
	if x != nil {
...
func (x *RoomBook) GetGiftContent() string {
	if x != nil {
...
type RoomBookResponse struct {
	...
	Entity *RoomBook     `protobuf:"bytes,4,opt,name=entity,proto3" json:"entity"`
	Items  []*RoomBook   `protobuf:"bytes,5,rep,name=items,proto3" json:"items"`
}
...
type AllRoomTypeAndAvailableRoom struct {
	...
	RoomTypeId int64 `protobuf:"varint,1,opt,name=room_type_id,json=roomTypeId,proto3" json:"room_type_id" validate:"required" label:"房型"`
	// @inject_tag: validate:"required" label:"房型名称"
	RoomTypeName string  `protobuf:"bytes,2,opt,name=room_type_name,json=roomTypeName,proto3" json:"room_type_name" validate:"required" label:"房型名称"`
	CountableNum int32   `protobuf:"varint,3,opt,name=countable_num,json=countableNum,proto3" json:"countable_num"` // 可订房间数
	Price        float32 `protobuf:"fixed32,4,opt,name=price,proto3" json:"price"`                                  // 门市价
	AvePrice     float32 `protobuf:"fixed32,5,opt,name=ave_price,json=avePrice,proto3" json:"ave_price"`            // 房间均价
	// @inject_tag: validate:"required" label:"房间数量"
	RoomNum      int32            `protobuf:"varint,6,opt,name=room_num,json=roomNum,proto3" json:"room_num" validate:"required" label:"房间数量"`                // 预定房间数量
	BreakfastNum int32            `protobuf:"varint,7,opt,name=breakfast_num,json=breakfastNum,proto3" json:"breakfast_num"` // 早餐份数
	IsChecked    bool             `protobuf:"varint,8,opt,name=is_checked,json=isChecked,proto3" json:"is_checked"`          // 是否已选择
	RoomList     []*BookRoomList  `protobuf:"bytes,9,rep,name=room_list,json=roomList,proto3" json:"room_list"`
	PriceList    []*BookPriceList `protobuf:"bytes,10,rep,name=price_list,json=priceList,proto3" json:"price_list"`
}
...
type BookRoomList struct {
	...
	IsChecked bool   `protobuf:"varint,3,opt,name=is_checked,json=isChecked,proto3" json:"is_checked"` // 是否已选择
}
...
type AllRoomTypeAndAvailableRoomResponse struct {
	...
	Info   *common.Info                   `protobuf:"bytes,2,opt,name=info,proto3" json:"info"`
	Pager  *common.Pager                  `protobuf:"bytes,3,opt,name=pager,proto3" json:"pager"`
	Entity *AllRoomTypeAndAvailableRoom   `protobuf:"bytes,4,opt,name=entity,proto3" json:"entity"`
	Items  []*AllRoomTypeAndAvailableRoom `protobuf:"bytes,5,rep,name=items,proto3" json:"items"`
}
...
var file_roomBookService_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x49, 0x64, 0x73, 0x22, 0xf3, 0x06, 0x0a, 0x08, 0x52, 0x6f, 0x6f,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x8d, 0x02, 0x0a, 0x23, 0x41, 0x6c, 0x6c, 0x52, 0x6f, 0x6f, 0x6d, 0x54, 0x79, 0x70,
	0x65, 0x41, 0x6e, 0x64, 0x41, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x6f, 0x6f,
	0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x23, 0x0a, 0x05, 0x65, 0x72, 0x72,
	...
	0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x63,
	...
	,
	...
	0x1a, 0x2d, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x6c, 0x6c, 0x52,
	0x6f, 0x6f, 0x6d, 0x54, 0x79, 0x70, 0x65, 0x41, 0x6e, 0x64, 0x41, 0x76, 0x61, 0x69, 0x6c, 0x61,
	0x62, 0x6c, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x43, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x41, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x52,
	0x6f, 0x6f, 0x6d, 0x12, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x52,
	0x6f, 0x6f, 0x6d, 0x42, 0x6f, 0x6f, 0x6b, 0x57, 0x68, 0x65, 0x72, 0x65, 0x1a, 0x16, 0x2e, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x65, 0x73, 0x70,
