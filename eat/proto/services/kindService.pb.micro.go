...
// Api Endpoints for InKindService service

func NewInKindServiceEndpoints() []*api.Endpoint {
	return []*api.Endpoint{}
}
...
// Api Endpoints for MyInKindService service

func NewMyInKindServiceEndpoints() []*api.Endpoint {
	return []*api.Endpoint{}
}
...
// Api Endpoints for OutKindService service

func NewOutKindServiceEndpoints() []*api.Endpoint {
	return []*api.Endpoint{}
}
...
// Api Endpoints for MyOutKindService service

func NewMyOutKindServiceEndpoints() []*api.Endpoint {
	return []*api.Endpoint{}
}
