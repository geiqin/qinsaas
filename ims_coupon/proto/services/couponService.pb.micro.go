...
// Api Endpoints for MyCouponService service

func NewMyCouponServiceEndpoints() []*api.Endpoint {
	return []*api.Endpoint{}
}
...
type MyCouponService interface {
	...
	//未领取的优惠券列表
	UncollectedList(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*CouponResponse, error)
	//可使用的优惠券列表
...
func (c *myCouponService) UncollectedList(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*CouponResponse, error) {
...
type MyCouponServiceHandler interface {
	...
	//未领取的优惠券列表
	UncollectedList(context.Context, *common.Empty, *CouponResponse) error
	//可使用的优惠券列表
...
func RegisterMyCouponServiceHandler(s server.Server, hdlr MyCouponServiceHandler, opts ...server.HandlerOption) error {
	type myCouponService interface {
		...
		UncollectedList(ctx context.Context, in *common.Empty, out *CouponResponse) error
...
func (h *myCouponServiceHandler) UncollectedList(ctx context.Context, in *common.Empty, out *CouponResponse) error {
...
type CouponService interface {
	...
	Get(ctx context.Context, in *Coupon, opts ...client.CallOption) (*CouponResponse, error)
	//获取优惠券列表（下拉框选择专用）
	ValidList(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*CouponResponse, error)
	//查询优惠劵
...
func (c *couponService) ValidList(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*CouponResponse, error) {
...
type CouponServiceHandler interface {
	...
	Get(context.Context, *Coupon, *CouponResponse) error
	//获取优惠券列表（下拉框选择专用）
	ValidList(context.Context, *common.Empty, *CouponResponse) error
	//查询优惠劵
...
func RegisterCouponServiceHandler(s server.Server, hdlr CouponServiceHandler, opts ...server.HandlerOption) error {
	type couponService interface {
		...
		Get(ctx context.Context, in *Coupon, out *CouponResponse) error
		ValidList(ctx context.Context, in *common.Empty, out *CouponResponse) error
...
func (h *couponServiceHandler) ValidList(ctx context.Context, in *common.Empty, out *CouponResponse) error {
