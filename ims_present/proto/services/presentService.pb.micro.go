...
// Api Endpoints for PresentService service

func NewPresentServiceEndpoints() []*api.Endpoint {
	return []*api.Endpoint{}
}
...
type PresentService interface {
	...
	Search(ctx context.Context, in *common.BaseWhere, opts ...client.CallOption) (*PresentResponse, error)
}
...
func (c *presentService) Search(ctx context.Context, in *common.BaseWhere, opts ...client.CallOption) (*PresentResponse, error) {
...
type PresentServiceHandler interface {
	...
	Search(context.Context, *common.BaseWhere, *PresentResponse) error
}
...
func RegisterPresentServiceHandler(s server.Server, hdlr PresentServiceHandler, opts ...server.HandlerOption) error {
	type presentService interface {
		...
		Search(ctx context.Context, in *common.BaseWhere, out *PresentResponse) error
	}
	type PresentService struct {
		presentService
	}
...
func (h *presentServiceHandler) Search(ctx context.Context, in *common.BaseWhere, out *PresentResponse) error {
