...
type MyApplierService interface {
	// 检查用户是否存在可申请的分销等级
	Check(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*ApplierResponse, error)
	// 发起申请销售员
	Apply(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*ApplyInfoResponse, error)
	// 提交销售员申请
...
func (c *myApplierService) Check(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*ApplierResponse, error) {
...
func (c *myApplierService) Apply(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*ApplyInfoResponse, error) {
...
type MyApplierServiceHandler interface {
	// 检查用户是否存在可申请的分销等级
	Check(context.Context, *common.Empty, *ApplierResponse) error
	// 发起申请销售员
	Apply(context.Context, *common.Empty, *ApplyInfoResponse) error
	// 提交销售员申请
...
func RegisterMyApplierServiceHandler(s server.Server, hdlr MyApplierServiceHandler, opts ...server.HandlerOption) error {
	type myApplierService interface {
		Check(ctx context.Context, in *common.Empty, out *ApplierResponse) error
		Apply(ctx context.Context, in *common.Empty, out *ApplyInfoResponse) error
...
func (h *myApplierServiceHandler) Check(ctx context.Context, in *common.Empty, out *ApplierResponse) error {
	return h.MyApplierServiceHandler.Check(ctx, in, out)
}

func (h *myApplierServiceHandler) Apply(ctx context.Context, in *common.Empty, out *ApplyInfoResponse) error {
