...
func (c *myLeaderApplierService) Apply(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*ApplyInfoResponse, error) {
...
func (h *myLeaderApplierServiceHandler) Apply(ctx context.Context, in *common.Empty, out *ApplyInfoResponse) error {
