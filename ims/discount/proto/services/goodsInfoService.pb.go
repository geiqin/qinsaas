...
type GoodsInfo struct {
	...
	Disabled    bool    `protobuf:"varint,20,opt,name=disabled,proto3" json:"disabled"`           // 是否参与其他活动
	SkuNum      int32   `protobuf:"varint,21,opt,name=sku_num,json=skuNum,proto3" json:"sku_num"` // 规格商品数量
}
