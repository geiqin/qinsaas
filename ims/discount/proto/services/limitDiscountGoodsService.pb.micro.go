...
// Api Endpoints for LimitDiscountGoodsService service

func NewLimitDiscountGoodsServiceEndpoints() []*api.Endpoint {
	return []*api.Endpoint{}
}
...
type LimitDiscountGoodsService interface {
	...
	Search(ctx context.Context, in *common.BaseWhere, opts ...client.CallOption) (*LimitDiscountGoodsResponse, error)
}
...
func (c *limitDiscountGoodsService) Search(ctx context.Context, in *common.BaseWhere, opts ...client.CallOption) (*LimitDiscountGoodsResponse, error) {
...
type LimitDiscountGoodsServiceHandler interface {
	...
	Search(context.Context, *common.BaseWhere, *LimitDiscountGoodsResponse) error
}
...
func RegisterLimitDiscountGoodsServiceHandler(s server.Server, hdlr LimitDiscountGoodsServiceHandler, opts ...server.HandlerOption) error {
	type limitDiscountGoodsService interface {
		...
		Search(ctx context.Context, in *common.BaseWhere, out *LimitDiscountGoodsResponse) error
	}
	type LimitDiscountGoodsService struct {
...
func (h *limitDiscountGoodsServiceHandler) Search(ctx context.Context, in *common.BaseWhere, out *LimitDiscountGoodsResponse) error {
