...
type LimitDiscountService interface {
	...
	//查询活动列表
	Search(ctx context.Context, in *common.BaseWhere, opts ...client.CallOption) (*LimitDiscountResponse, error)
	//获取活动列表
	List(ctx context.Context, in *common.BaseWhere, opts ...client.CallOption) (*LimitDiscountResponse, error)
	// 分页查询可参与活动的商品列表
...
func (c *limitDiscountService) Search(ctx context.Context, in *common.BaseWhere, opts ...client.CallOption) (*LimitDiscountResponse, error) {
...
func (c *limitDiscountService) List(ctx context.Context, in *common.BaseWhere, opts ...client.CallOption) (*LimitDiscountResponse, error) {
...
type LimitDiscountServiceHandler interface {
	...
	//查询活动列表
	Search(context.Context, *common.BaseWhere, *LimitDiscountResponse) error
	//获取活动列表
	List(context.Context, *common.BaseWhere, *LimitDiscountResponse) error
	// 分页查询可参与活动的商品列表
...
func RegisterLimitDiscountServiceHandler(s server.Server, hdlr LimitDiscountServiceHandler, opts ...server.HandlerOption) error {
	type limitDiscountService interface {
		...
		Search(ctx context.Context, in *common.BaseWhere, out *LimitDiscountResponse) error
		List(ctx context.Context, in *common.BaseWhere, out *LimitDiscountResponse) error
...
func (h *limitDiscountServiceHandler) Search(ctx context.Context, in *common.BaseWhere, out *LimitDiscountResponse) error {
	return h.LimitDiscountServiceHandler.Search(ctx, in, out)
}

func (h *limitDiscountServiceHandler) List(ctx context.Context, in *common.BaseWhere, out *LimitDiscountResponse) error {
