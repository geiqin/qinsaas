...
type NavService interface {
	...
	Get(ctx context.Context, in *NavWhere, opts ...client.CallOption) (*NavResponse, error)
	Delete(ctx context.Context, in *NavWhere, opts ...client.CallOption) (*NavResponse, error)
	List(ctx context.Context, in *NavWhere, opts ...client.CallOption) (*NavResponse, error)
	Search(ctx context.Context, in *NavWhere, opts ...client.CallOption) (*NavResponse, error)
}
...
func (c *navService) Get(ctx context.Context, in *NavWhere, opts ...client.CallOption) (*NavResponse, error) {
...
func (c *navService) Delete(ctx context.Context, in *NavWhere, opts ...client.CallOption) (*NavResponse, error) {
...
func (c *navService) List(ctx context.Context, in *NavWhere, opts ...client.CallOption) (*NavResponse, error) {
...
func (c *navService) Search(ctx context.Context, in *NavWhere, opts ...client.CallOption) (*NavResponse, error) {
...
type NavServiceHandler interface {
	...
	Get(context.Context, *NavWhere, *NavResponse) error
	Delete(context.Context, *NavWhere, *NavResponse) error
	List(context.Context, *NavWhere, *NavResponse) error
	Search(context.Context, *NavWhere, *NavResponse) error
}
...
func RegisterNavServiceHandler(s server.Server, hdlr NavServiceHandler, opts ...server.HandlerOption) error {
	type navService interface {
		...
		Get(ctx context.Context, in *NavWhere, out *NavResponse) error
		Delete(ctx context.Context, in *NavWhere, out *NavResponse) error
		List(ctx context.Context, in *NavWhere, out *NavResponse) error
		Search(ctx context.Context, in *NavWhere, out *NavResponse) error
	}
	type NavService struct {
		navService
	}
...
func (h *navServiceHandler) Get(ctx context.Context, in *NavWhere, out *NavResponse) error {
	return h.NavServiceHandler.Get(ctx, in, out)
}

func (h *navServiceHandler) Delete(ctx context.Context, in *NavWhere, out *NavResponse) error {
	return h.NavServiceHandler.Delete(ctx, in, out)
}

func (h *navServiceHandler) List(ctx context.Context, in *NavWhere, out *NavResponse) error {
	return h.NavServiceHandler.List(ctx, in, out)
}

func (h *navServiceHandler) Search(ctx context.Context, in *NavWhere, out *NavResponse) error {
