...
type ImageService interface {
	...
	Search(ctx context.Context, in *common.BaseWhere, opts ...client.CallOption) (*ImageResponse, error)
...
func (c *imageService) Search(ctx context.Context, in *common.BaseWhere, opts ...client.CallOption) (*ImageResponse, error) {
...
type ImageServiceHandler interface {
	...
	Search(context.Context, *common.BaseWhere, *ImageResponse) error
...
func RegisterImageServiceHandler(s server.Server, hdlr ImageServiceHandler, opts ...server.HandlerOption) error {
	type imageService interface {
		...
		Search(ctx context.Context, in *common.BaseWhere, out *ImageResponse) error
...
func (h *imageServiceHandler) Search(ctx context.Context, in *common.BaseWhere, out *ImageResponse) error {
