...
type AttributeWhere struct {
	...
	AttributeTypeId int32   `protobuf:"varint,7,opt,name=attribute_type_id,json=attributeTypeId,proto3" json:"attribute_type_id,omitempty"`
}
...
type Attribute struct {
	...
	AttributeTypeId int32  `protobuf:"varint,2,opt,name=attribute_type_id,json=attributeTypeId,proto3" json:"attribute_type_id,omitempty"`
...
type AttributeResponse struct {
	...
	Entity *Attribute    `protobuf:"bytes,4,opt,name=entity,proto3" json:"entity,omitempty"`
	Items  []*Attribute  `protobuf:"bytes,5,rep,name=items,proto3" json:"items,omitempty"`
}
