...
var file_tagService_proto_rawDesc = []byte{
	...
	0x2e, 0x54, 0x61, 0x67, 0x52, 0x08, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x72, 0x65, 0x6e, 0x12, 0x10,
	...
	0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x32, 0xbb, 0x02, 0x0a, 0x0a, 0x54, 0x61, 0x67,
	...
	0x61, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x34, 0x0a, 0x06,
...
var file_tagService_proto_depIdxs = []int32{
	0,  // 0: services.Tag.children:type_name -> services.Tag
	0,  // 1: services.TagResponse.entity:type_name -> services.Tag
	2,  // 2: services.TagResponse.pager:type_name -> common.Pager
	0,  // 3: services.TagResponse.items:type_name -> services.Tag
	3,  // 4: services.TagResponse.error:type_name -> common.Error
	4,  // 5: services.TagResponse.info:type_name -> common.Info
	...
	5,  // 11: services.TagService.List:input_type -> common.BaseWhere
	1,  // 12: services.TagService.Create:output_type -> services.TagResponse
	1,  // 13: services.TagService.Update:output_type -> services.TagResponse
	1,  // 14: services.TagService.Delete:output_type -> services.TagResponse
	1,  // 15: services.TagService.Get:output_type -> services.TagResponse
	1,  // 16: services.TagService.Search:output_type -> services.TagResponse
	1,  // 17: services.TagService.List:output_type -> services.TagResponse
