...
func (c *storeService) Auth(ctx context.Context, in *StoreSecret, opts ...client.CallOption) (*common.TokenResponse, error) {
...
func (c *storeService) Switch(ctx context.Context, in *Store, opts ...client.CallOption) (*common.TokenResponse, error) {
...
func (c *storeService) Info(ctx context.Context, in *common.Empty, opts ...client.CallOption) (*StoreResponse, error) {
...
func (h *storeServiceHandler) Auth(ctx context.Context, in *StoreSecret, out *common.TokenResponse) error {
	return h.StoreServiceHandler.Auth(ctx, in, out)
}

func (h *storeServiceHandler) Switch(ctx context.Context, in *Store, out *common.TokenResponse) error {
	return h.StoreServiceHandler.Switch(ctx, in, out)
}

func (h *storeServiceHandler) Info(ctx context.Context, in *common.Empty, out *StoreResponse) error {
